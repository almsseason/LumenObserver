...
export default function LumenObserver() {
  ...
  async function runObservation() {
    setStatus("Observing Base network…");
  ...
  return (
    <OnchainKitProvider chain={chain}>
      <div style={{ maxWidth: 960, margin: "60px auto", fontFamily: "system-ui" }}>
        <h1>LumenObserver — Built for Base</h1>
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
          ...
          <button onClick={runObservation} style={{ padding: "6px 12px" }}>
            Run Observation
          </button>

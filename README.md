...
LumenObserver is a Base-focused repository designed to provide a clean and repeatable snapshot of Base network state, wallet connectivity, and RPC consistency using official Coinbase tooling.

The repository emphasizes clarity and traceability rather than application logic, making it suitable for infrastructure validation and tooling verification.

## Project Goals

This repository exists to:
- Validate Base Mainnet and Base Sepolia availability
- Exercise OnchainKit wallet connection flows
- Perform read-only Base RPC queries using Viem
...
Primary file: app/lumenObserver.ts
...
- Exposes Basescan explorer URLs for transparent verification
